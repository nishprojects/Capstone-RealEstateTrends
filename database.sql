...
/****** Object:  Table [dbo].[InflationvsPrices]    Script Date: 6/27/2023 12:55:12 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[InflationvsPrices](
	...
	[rowguid] [uniqueidentifier] ROWGUIDCOL  NOT NULL,
	[ModifiedDate] [datetime] NOT NULL,
 CONSTRAINT [PK_InflationvsPrices_ID] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
ALTER TABLE [dbo].[InflationvsPrices] ADD  CONSTRAINT [DF_InflationvsPrices_rowguid]  DEFAULT (newid()) FOR [rowguid]
GO

ALTER TABLE [dbo].[InflationvsPrices] ADD  CONSTRAINT [DF_InflationvsPrices_ModifiedDate]  DEFAULT (getdate()) FOR [ModifiedDate]
GO
